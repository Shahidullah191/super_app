...
class ServiceHistoryScreen extends GetView<ServiceController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('service_history'.tr)),
      body: Obx(() {
        if (controller.isLoading.value && controller.serviceHistory.isEmpty) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (_, i) =>
              _BookingCard(booking: controller.serviceHistory[i]),
        );
      }),
    );
  }
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      '${booking['category']} - ${booking['provider']}',
                      style: AppTextStyles.bodyMedium.copyWith(
                        fontWeight: FontWeight.bold,
                      ),
                    ),
